...
import { lostPets, getPetEmoji } from '@/data/mockPets'
            ...
            >
              ...
              <div className="p-6">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
                        ...
                        {pet.status === 'critical' ? 'CRÍTICO' : pet.status === 'urgent' ? 'URGENTE' : 'NORMAL'}
                      </span>
                    </div>
                ...
                <div className="space-y-2 mb-4">
                  <p className="text-sm text-foreground/60"><strong>Raza:</strong> {pet.breed}</p>
