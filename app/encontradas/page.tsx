...
import { foundPets } from '@/data/mockPets'
            ...
            >
              ...
              <div className="p-6">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
                        ...
                        {pet.status === 'high' ? 'ALTA COINCIDENCIA' : pet.status === 'medium' ? 'POSIBLE MATCH' : 'REPORTADA'}
                      </span>
                    </div>
                ...
                <div className="space-y-2 mb-4">
                  <p className="text-sm text-foreground/60"><strong>Raza/Descripción:</strong> {pet.breed}</p>
                  <p className="text-sm text-foreground/60"><strong>Color:</strong> {pet.color}</p>
                  <p className="text-sm text-foreground/60"><strong>Estado:</strong> {pet.condition}</p>
                </div>

                <div className="flex flex-col sm:flex-row gap-4 mb-4 text-sm text-foreground/60">
                  <div className="flex items-center gap-2"><MapPin className="w-4 h-4" />{pet.location}</div>
                  <div className="flex items-center gap-2"><Calendar className="w-4 h-4" />{pet.date}</div>
                </div>
